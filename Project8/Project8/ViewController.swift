...
//  Project8
//
//  Created by Enrique Casas on 9/27/21.
//
...
//            for check in letterButtons {
//                if check.isHidden == false {
//                    print(check.isHidden)
//                    break
//                } else {
...
//            }
            ...
            let ac = UIAlertController(title: "Wrong Answer!", message: "This is an incorrect answer. Try again!", preferredStyle: .alert)
